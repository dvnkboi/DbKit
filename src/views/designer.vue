<template>
  <transition
    ...
    appear
  >
    <div class="flex flex-row justify-center items-center select-none transform transition duration-300">
      <div
      ...
      >
        <div
          ref="playGround"
          class="w-[10000px] h-[10000px] relative flex-none bg-grayish-900"
        >
          <transition-group
            name="fade"
            appear
          ...
          <div class="fixed bottom-6 left-0 right-80 flex justify-center items-center">
            ...
            >
              <div
                ...
                :class="{ 'animate-pulse': downloadable }"
              ...
              >
                ...
                <i
                  v-if="!generating"
                  class="ri-folder-download-fill group-hover:-translate-y-0.5 transition-transform duration-300 font-thin"
                />
                <i
                  v-else
                  class="ri-loader-fill group-hover:-translate-y-0.5 transition-transform duration-300 font-thin animate-spin"
                />
              </div>
            </transition>
          </div>
          <div class="fixed top-4 left-4 flex justify-start items-start flex-col gap-2">
            ...
            <div
              v-if="tooManyEntities"
              class="text-red-400 animate-pulse font-semibold text-base"
            >
              too many entities
            </div>
          </div>
